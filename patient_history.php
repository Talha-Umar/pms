                ...
                <table id="patient_history" class="table table-striped table-bordered">
                  ...
                  <thead>
                    <tr class="bg-gradient-primary text-light">
                      <th class="p-1 text-center">P.No</th>
                      <th class="p-1 text-center">Visit Date</th>
                      <th class="p-1 text-center">Next Visit Date</th>
                      <th class="p-1 text-center">ChiefComplaint</th>
                      <th class="p-1 text-center">Medicine</th>
                      <th class="p-1 text-center">Advised</th>
                      <th class="p-1 text-center">Clinical History</th>
