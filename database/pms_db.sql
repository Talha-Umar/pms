...
CREATE TABLE `patient_visits` (
  ...
  `chief_complaint` varchar(23) NOT NULL,
  `advised` varchar(12) NOT NULL,
  `clinical_history` varchar(30) NOT NULL,
...
INSERT INTO `patient_visits` (`id`, `visit_date`, `next_visit_date`, `chief_complaint`, `advised`, `clinical_history`, `patient_id`) VALUES
